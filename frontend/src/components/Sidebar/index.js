...
import LogoE from '../../assets/images/pro.jpg'
...
const Sidebar = () => {
    ...
    return(
        <div className = 'nav-bar'> 
            ...
            <ul>
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "https://www.linkedin.com/in/srikrishna-hireholi-603503298/">
                        <FontAwesomeIcon icon={faLinkedin} color = "#4d4d4e" />
                    </a>
                </li>
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "https://github.com/SriKrishna134">
